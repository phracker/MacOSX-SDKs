...
*/
- (id)scriptingValueForSpecifier:(NSScriptObjectSpecifier *)objectSpecifier NS_AVAILABLE(10_5, NA);
...
*/
- (id)copyScriptingValue:(id)value forKey:(NSString *)key withProperties:(NSDictionary *)properties NS_AVAILABLE(10_5, NA);
...
*/
- (id)newScriptingObjectOfClass:(Class)objectClass forValueForKey:(NSString *)key withContentsValue:(id)contentsValue properties:(NSDictionary *)properties NS_AVAILABLE(10_5, NA);
