 ...
 */
@property(nonatomic, readonly) EKAlarmType type __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_NA);
 ...
 */
@property(nonatomic, copy) NSString *emailAddress __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_NA);
 ...
 */
@property(nonatomic, copy) NSString *soundName __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_NA);
