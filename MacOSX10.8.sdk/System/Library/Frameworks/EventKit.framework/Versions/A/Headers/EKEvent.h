...
@class EKEventStore, EKCalendar, EKAlarm, EKParticipant;
 ...
 */
@property(nonatomic, readonly) NSDate *occurrenceDate __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_NA);
 ...
 */
@property(nonatomic, readonly) NSString *birthdayPersonUniqueID __OSX_AVAILABLE_STARTING(__MAC_10_8,__IPHONE_NA);
