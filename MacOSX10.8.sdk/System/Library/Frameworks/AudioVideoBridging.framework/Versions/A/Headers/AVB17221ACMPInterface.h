...
/*!
	...
	@discussion	AVB17221ACMPInterface is a concrete subclass of AVB1722ControlInterface providing the access to the IEEE P1722.1 AVDECC Connection Management Protocol (ACMP) interface.
				It provides callbacks per entity GUID via a handler object implementing the AVB17221ACMPClient protocol. AVB17221ACMPInterface objects
 ...
 */
- (BOOL)setHandler:(id<AVB17221ACMPClient>)handler forGUID:(uint64_t)targetGUID;
/*!
