 ...
 * Orientation values from 1 to 8 as defined in the TIFF spec are supporrted.
...
- (CIImage *)imageByCompositingOverImage:(CIImage *)dest __OSX_AVAILABLE_STARTING(__MAC_10_4, __IPHONE_8_0);
