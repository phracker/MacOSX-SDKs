...
- (instancetype)initWithContent:(id)content NS_DESIGNATED_INITIALIZER;
...
@property (assign) Class objectClass;   // sets the object class used when creating new objects
