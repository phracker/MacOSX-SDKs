...
module Config
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.8/universal-darwin13.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--disable-dependency-tracking' '--enable-pthread' '--enable-shared' '--prefix=/System/Library/Frameworks/Ruby.framework/Versions/1.8/usr' '--with-sitedir=/Library/Ruby/Site' '--mandir=/usr/local/share/man' 'ac_cv_func_getcontext=no' 'ac_cv_func_setcontext=no' 'CC=xcrun cc' 'CFLAGS=#{ARCHFLAGS} -g -Os -pipe -fno-common -DENABLE_DTRACE' 'LDFLAGS=#{ARCHFLAGS} '"
  CONFIG["vendordir"] = "$(libdir)/ruby/vendor_ruby"
  CONFIG["sitedir"] = "$(DESTDIR)/Library/Ruby/Site"
  CONFIG["sitearch"] = "universal-darwin13.0"
  CONFIG["arch"] = "universal-darwin13.0"
  ...
  CONFIG["target"] = "i686-apple-darwin13.0"
  CONFIG["host_os"] = "darwin13.0"
  CONFIG["host_vendor"] = "apple"
  CONFIG["host_cpu"] = "i686"
  CONFIG["host"] = "i686-apple-darwin13.0"
  CONFIG["build_os"] = "darwin13.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "i686"
  CONFIG["build"] = "i686-apple-darwin13.0"
  CONFIG["TEENY"] = "7"
  CONFIG["MINOR"] = "8"
  CONFIG["MAJOR"] = "1"
  CONFIG["target_alias"] = ""
  ...
  CONFIG["ECHO_C"] = "\\\\c"
  CONFIG["DEFS"] = ""
  CONFIG["mandir"] = "$(DESTDIR)/usr/local/share/man"
