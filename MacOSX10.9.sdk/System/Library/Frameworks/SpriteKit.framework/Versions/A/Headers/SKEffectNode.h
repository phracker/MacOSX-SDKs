 ...
 */
@property (SK_NONATOMIC_IOSONLY, retain) CIFilter *filter;
...
@property (SK_NONATOMIC_IOSONLY) BOOL shouldCenterFilter;

/**
 Enable the SKEffectNode.
 
 The SKEffectNode has no effect when appliesEffects is not enabled, this is useful for setting up an effect to use later on. Defaults to NO.
 */
@property (SK_NONATOMIC_IOSONLY) BOOL shouldEnableEffects;
 ...
 */
@property (SK_NONATOMIC_IOSONLY) BOOL shouldRasterize;
