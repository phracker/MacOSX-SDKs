 ...
 */
@property(nonatomic) BOOL automaticallyAdjustsZRange SCENEKIT_AVAILABLE(10_9, NA);
 ...
 */
@property(nonatomic) double orthographicScale SCENEKIT_AVAILABLE(10_9, NA);
...
- (void)setProjectionTransform:(CATransform3D)projectionTransform SCENEKIT_AVAILABLE(10_9, NA);
 ...
 */
@property(nonatomic) CGFloat focalDistance SCENEKIT_AVAILABLE(10_9, NA);
 ...
 */
@property(nonatomic) CGFloat focalSize SCENEKIT_AVAILABLE(10_9, NA);
 ...
 */
@property(nonatomic) CGFloat focalBlurRadius SCENEKIT_AVAILABLE(10_9, NA);
 ...
 */
@property(nonatomic) CGFloat aperture SCENEKIT_AVAILABLE(10_9, NA);
