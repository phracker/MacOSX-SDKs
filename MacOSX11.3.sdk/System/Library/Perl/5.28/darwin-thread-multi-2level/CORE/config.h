 ...
 */
#define	PERL_PREPENDTOPATH	"/Library/Perl/5.28/PrependToPath"

/* PERL_APPENDTOPATH:
 *	If defined, this is the path to a file containing colon-separated
 *	paths to append to @INC.
 */
#define	PERL_APPENDTOPATH	"/Library/Perl/5.28/AppendToPath"

/* UPDATESLIB:
 *	This is the path to the Updates directory (which comes before
 *	the system perl directory in @INC.
 */
#define UPDATESLIB		"/Library/Perl/Updates/5.28.2"
 ...
 */
#define NO_NETWORK_LIBRARY_PERL_FILE	"/Library/Perl/5.28/No_Network_Library_Perl"
