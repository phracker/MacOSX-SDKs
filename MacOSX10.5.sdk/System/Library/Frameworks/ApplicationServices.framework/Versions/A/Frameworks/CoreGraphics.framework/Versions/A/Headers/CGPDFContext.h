...
CG_EXTERN void CGPDFContextClose(CGContextRef context) AVAILABLE_MAC_OS_X_VERSION_10_5_AND_LATER;
...
CG_EXTERN void CGPDFContextAddDestinationAtPoint(CGContextRef context, CFStringRef name, CGPoint point) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextMediaBox AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextCropBox AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* The bleed box for the document or for a given page. Optional; if
 * present, the value of this key must be a CFData containing a CGRect
 * (stored by value, not by reference). */

CG_EXTERN const CFStringRef kCGPDFContextBleedBox AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* The trim box for the document or for a given page. Optional; if present,
 * the value of this key must be a CFData containing a CGRect (stored by
 * value, not by reference). */

CG_EXTERN const CFStringRef kCGPDFContextTrimBox AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* The art box for the document or for a given page. Optional; if present,
 * the value of this key must be a CFData containing a CGRect (stored by
 * value, not by reference). */

CG_EXTERN const CFStringRef kCGPDFContextArtBox AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextTitle AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* The name of the person who created this document. Optional; if present,
 * the value of this key must be a CFString. */

CG_EXTERN const CFStringRef kCGPDFContextAuthor AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* The subject of a document. Optional; if present, the value of this key
 * must be a CFString. */

CG_EXTERN const CFStringRef kCGPDFContextSubject AVAILABLE_MAC_OS_X_VERSION_10_5_AND_LATER;

/* The keywords for this document. This key is optional. If the value of
 * this key is a CFString, the /Keywords entry will be the specified
 * string. If the value of this key is a CFArray, then it must be an array
 * of CFStrings. The /Keywords entry will in this case be the concatenation
 * of the specified strings separated by commas (","). In addition, an
 * entry with the key "/AAPL:Keywords" will be stored in the document
 * information dictionary; its value is an array consisting of each of the
 * specified strings. The value of this key must be in one of the above
 * forms; otherwise, this key is ignored. */

CG_EXTERN const CFStringRef kCGPDFContextKeywords AVAILABLE_MAC_OS_X_VERSION_10_5_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextCreator AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextOwnerPassword AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextUserPassword AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextEncryptionKeyLength AVAILABLE_MAC_OS_X_VERSION_10_5_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextAllowsPrinting AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* Used to specify whether the document allows copying when unlocked with
 * the user password. The value of this key must be a CFBooleanRef. The
 * default value of this key is "kCFBooleanTrue". */

CG_EXTERN const CFStringRef kCGPDFContextAllowsCopying AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFContextOutputIntent AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFXOutputIntentSubtype AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
 ...
 *    in a human- or machine-readable form. This key is required; the value
 *    of this key must be a CFString. For best results, the string should
 *    be representable losslessly in ASCII encoding. */

CG_EXTERN const CFStringRef kCGPDFXOutputConditionIdentifier AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFXOutputCondition AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFXRegistryName AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFXInfo AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
CG_EXTERN const CFStringRef kCGPDFXDestinationOutputProfile AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
 ...
 * document catalog. Each dictionary in the array must be of form specified
 * above for the "kCGPDFContextOutputIntent" key, except that only the
 * first dictionary in the array may contain the kCGPDFXOutputIntentSubtype
...
CG_EXTERN const CFStringRef kCGPDFContextOutputIntents AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
