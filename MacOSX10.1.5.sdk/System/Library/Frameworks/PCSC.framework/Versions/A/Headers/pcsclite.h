...
#define PCSC_USE_WINTYPES FALSE
...
#define PCSCLITE_CLIENTLOCK_FILE        "/tmp/.pcsclk"
#define PCSCLITE_RXSHM_FILE             "/tmp/.pcscrx"
#define PCSCLITE_TXSHM_FILE             "/tmp/.pcsctx"
...
#define PCSCLITE_VERSION_NUMBER		"0.9.3" /* Current version      */
#define PCSCLITE_MAX_MESSAGE_SIZE       2048    /* Transport msg len    */
#define PCSCLITE_CLIENT_ATTEMPTS        1500    /* Attempts to reach sv */
#define PCSCLITE_MCLIENT_ATTEMPTS       250     /* Attempts to reach sv */
#define PCSCLITE_SERVER_ATTEMPTS        100     /* Attempts to reach cl */
