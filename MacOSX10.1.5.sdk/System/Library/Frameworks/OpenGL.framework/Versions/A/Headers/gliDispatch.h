...
typedef struct __GLIExtensionDispatchRec {
	...
	void (*secondary_color3b_EXT)(GLIContext ctx, GLbyte red, GLbyte green, GLbyte blue);
	void (*secondary_color3bv_EXT)(GLIContext ctx, const GLbyte *v);
	void (*secondary_color3d_EXT)(GLIContext ctx, GLdouble red, GLdouble green, GLdouble blue);
	...
	void (*combiner_parameterfvNV)(GLIContext ctx, GLenum pname, const GLfloat *params);
	void (*combiner_parameterfNV)(GLIContext ctx, GLenum pname, GLfloat param);
	void (*combiner_parameterivNV)(GLIContext ctx, GLenum pname, const GLint *params);
	void (*combiner_parameteriNV)(GLIContext ctx, GLenum pname, GLint param);
	void (*combiner_inputNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
	void (*combiner_outputNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum abOutput, GLenum cdOutput, GLenum sumOutput, GLenum scale, GLenum bias, GLboolean abDotProduct, GLboolean cdDotProduct, GLboolean muxSum);
	void (*final_combiner_inputNV)(GLIContext ctx, GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
	void (*get_combiner_input_parameterfvNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLfloat *params);
	void (*get_combiner_input_parameterivNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLint *params);
	void (*get_combiner_output_parameterfvNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLfloat *params);
	void (*get_combiner_output_parameterivNV)(GLIContext ctx, GLenum stage, GLenum portion, GLenum pname, GLint *params);
	void (*get_final_combiner_input_parameterfvNV)(GLIContext ctx, GLenum variable, GLenum pname, GLfloat *params);
	void (*get_final_combiner_input_parameterivNV)(GLIContext ctx, GLenum variable, GLenum pname, GLint *params);
	...
	void (*pad_func_457)(void);
	void (*pad_func_458)(void);
	void (*pad_func_459)(void);
	
	void (*sample_coverage_ARB)(GLIContext ctx, GLclampf value, GLboolean invert);
	void (*sample_pass_ARB)(GLIContext ctx, GLenum mode);
	
	void (*pn_trianglesi_ATIX)(GLIContext ctx, GLenum pname, GLint param);
	void (*pn_trianglesf_ATIX)(GLIContext ctx, GLenum pname, GLfloat param);
