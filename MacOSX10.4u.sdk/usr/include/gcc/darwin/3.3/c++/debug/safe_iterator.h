...
namespace std
{
  namespace __debug
  {
	...
	_Safe_iterator_base. */
    inline bool __singular_aux(const _Safe_iterator_base* __x)
  ...
  template<typename _Iterator, typename _Sequence>
	...
	return __gnu_cxx::__is_same<const_iterator, _Safe_iterator>::value;
      }
	...
	_GLIBCXX_DEBUG_VERIFY(! this->_M_singular(),
			      _M_message(__dbg_msg_init_singular)
	...
	_GLIBCXX_DEBUG_VERIFY(!__x._M_singular(),
			      _M_message(__dbg_msg_init_copy_singular)
			      ._M_iterator(*this, "this")
	...
	: _Safe_iterator_base(__x, _M_constant()), _M_current(__x.base())
        { 
	  _GLIBCXX_DEBUG_VERIFY(!__x._M_singular(),
				_M_message(__dbg_msg_init_const_singular)
				._M_iterator(*this, "this")
				._M_iterator(__x, "other"));
	}
      ...
      {
	_GLIBCXX_DEBUG_VERIFY(!__x._M_singular(),
			      _M_message(__dbg_msg_copy_singular)
			      ._M_iterator(*this, "this")
			      ._M_iterator(__x, "other"));
	...
	_GLIBCXX_DEBUG_VERIFY(this->_M_dereferenceable(),
			      _M_message(__dbg_msg_bad_deref)
			      ._M_iterator(*this, "this"));
	return *_M_current;
      }
	...
	_GLIBCXX_DEBUG_VERIFY(this->_M_can_advance(__n) 
			      ...
			      _M_message(__dbg_msg_iter_subscript_oob)
	...
	return _M_current[__n];
      ...
      {
	_GLIBCXX_DEBUG_VERIFY(this->_M_can_advance(__n),
			      _M_message(__dbg_msg_advance_oob)
			      ._M_iterator(*this)._M_integer(__n));
	_M_current += __n;
	return *this;
      }
	...
	return __tmp;
      ...
      {
	_GLIBCXX_DEBUG_VERIFY(this->_M_can_advance(-__n),
			      _M_message(__dbg_msg_retreat_oob)
			      ._M_iterator(*this)._M_integer(__n));
	_M_current += -__n;
	return *this;
      }
	...
	return __tmp;
       ...
       */      
      _Iterator base() const { return _M_current; }
	...
	_Safe_iterator_base::_M_attach(const_cast<_Sequence*>(__seq),
      ...
      bool _M_incrementable() const { return this->_M_dereferenceable(); }
  ...
  template<typename _IteratorL, typename _IteratorR, typename _Sequence>
    ...
    { 
      _GLIBCXX_DEBUG_VERIFY(! __lhs._M_singular() && ! __rhs._M_singular(),
			    _M_message(__dbg_msg_iter_compare_bad)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
      _GLIBCXX_DEBUG_VERIFY(__lhs._M_can_compare(__rhs),
			    _M_message(__dbg_msg_compare_different)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
  ...
  template<typename _IteratorL, typename _IteratorR, typename _Sequence>
    ...
    { 
      _GLIBCXX_DEBUG_VERIFY(! __lhs._M_singular() && ! __rhs._M_singular(),
			    _M_message(__dbg_msg_iter_order_bad)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
      _GLIBCXX_DEBUG_VERIFY(__lhs._M_can_compare(__rhs),
			    _M_message(__dbg_msg_order_different)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
      return __lhs.base() < __rhs.base(); 
    }
  ...
  template<typename _IteratorL, typename _IteratorR, typename _Sequence>
    ...
    { 
      _GLIBCXX_DEBUG_VERIFY(! __lhs._M_singular() && ! __rhs._M_singular(),
			    _M_message(__dbg_msg_distance_bad)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
      _GLIBCXX_DEBUG_VERIFY(__lhs._M_can_compare(__rhs),
			    _M_message(__dbg_msg_distance_different)
			    ._M_iterator(__lhs, "lhs")
			    ._M_iterator(__rhs, "rhs"));
      return __lhs.base() - __rhs.base(); 
    }
...
#endif /* _GLIBCXX_DEBUG_SAFE_ITERATOR_H */
