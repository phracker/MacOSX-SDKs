 ...
 */
     ...
     *
     * Example:
     *    __API_PROHIBITED(macos)
     *    __API_PROHIBITED(watchos, tvos)
     */
    #define __API_PROHIBITED(...) __API_PROHIBITED_GET_MACRO(__VA_ARGS__,__API_PROHIBITED6,__API_PROHIBITED5,__API_PROHIBITED4,__API_PROHIBITED3,__API_PROHIBITED2,__API_PROHIBITED1, 0)(__VA_ARGS__)
