...
#include <AvailabilityInternal.h>
    ...
    /*
     * API Prohibition
     * Use to specify that an API is prohibited for a particular platform.
     *
     * Example:
     *    API_PROHIBITED(macos)
     *    API_PROHIBITED(watchos, tvos)
     */

    #define API_PROHIBITED(...) __API_PROHIBITED_GET_MACRO(__VA_ARGS__,__API_PROHIBITED6, __API_PROHIBITED5, __API_PROHIBITED4,__API_PROHIBITED3,__API_PROHIBITED2,__API_PROHIBITED1, 0)(__VA_ARGS__)
 #else
