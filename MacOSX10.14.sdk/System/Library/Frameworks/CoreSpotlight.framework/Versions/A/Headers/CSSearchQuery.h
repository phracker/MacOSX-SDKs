...
CORESPOTLIGHT_EXPORT NSString * const CSSearchQueryErrorDomain API_AVAILABLE(macos(10.12), ios(10.0)) API_UNAVAILABLE(tvos);
...
} API_AVAILABLE(macos(10.12), ios(10.0)) API_UNAVAILABLE(tvos);
