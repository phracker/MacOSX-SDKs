...
} API_AVAILABLE(macos(10.10), ios(7.0)) API_PROHIBITED(tvos, watchos);
...
typedef NS_ENUM(NSInteger, CLProximity) {
	...
	CLProximityNear,
	CLProximityFar
} API_AVAILABLE(ios(7.0)) API_PROHIBITED(tvos, watchos, macos);
...
- (instancetype)initCircularRegionWithCenter:(CLLocationCoordinate2D)center
								  ...
								  identifier:(NSString *)identifier API_DEPRECATED("Please see CLCircularRegion", ios(4.0, 7.0), macos(10.7, 10.10)) API_PROHIBITED(tvos);
 ...
 *    This method has been deprecated, please see CLCircularRegion.
 */
@property (readonly, nonatomic) CLLocationCoordinate2D center API_DEPRECATED("Please see CLCircularRegion", ios(4.0, 7.0), macos(10.7, 10.10)) API_PROHIBITED(tvos);
 ...
 *    This method has been deprecated, please see CLCircularRegion.
 */
@property (readonly, nonatomic) CLLocationDistance radius API_DEPRECATED("Please see CLCircularRegion", ios(4.0, 7.0), macos(10.7, 10.10)) API_PROHIBITED(tvos);
 ...
 *    This method has been deprecated, please see CLCircularRegion.
 */
- (BOOL)containsCoordinate:(CLLocationCoordinate2D)coordinate API_DEPRECATED("Please see CLCircularRegion", ios(4.0, 7.0), macos(10.7, 10.10)) API_PROHIBITED(tvos);
