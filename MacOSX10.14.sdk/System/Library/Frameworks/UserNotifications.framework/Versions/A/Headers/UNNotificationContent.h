...
@property (NS_NONATOMIC_IOSONLY, readonly, copy) NSString *launchImageName __API_PROHIBITED(macos, tvos);
...
// The launch image that will be used when the app is opened from the notification.
@property (NS_NONATOMIC_IOSONLY, copy) NSString *launchImageName __API_PROHIBITED(macos, tvos);
