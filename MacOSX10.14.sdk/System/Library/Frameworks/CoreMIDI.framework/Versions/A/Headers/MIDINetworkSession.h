...
MIDI_EXPORT extern NSString *const MIDINetworkBonjourServiceType API_AVAILABLE(ios(4.2)) API_PROHIBITED(macos, watchos, tvos);
...
*/
MIDI_EXPORT extern NSString *const MIDINetworkNotificationContactsDidChange API_AVAILABLE(ios(4.2)) API_PROHIBITED(macos, watchos, tvos);
MIDI_EXPORT extern NSString *const MIDINetworkNotificationSessionDidChange API_AVAILABLE(ios(4.2)) API_PROHIBITED(macos, watchos, tvos);
...
*/
MIDI_EXPORT API_AVAILABLE(ios(4.2)) API_PROHIBITED(macos, watchos, tvos)
