...
*/
IMAGECAPTURE_EXTERN NSString* const ICScannerStatusWarmingUp;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICScannerStatusWarmUpDone;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICScannerStatusRequestsOverviewScan;
...
IMAGECAPTURE_ENUM_AVAILABLE( 10_7, NA )
