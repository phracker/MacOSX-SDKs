...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanTakePicture;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanTakePictureUsingShutterReleaseOnCamera;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanDeleteOneFile;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanDeleteAllFiles;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanSyncClock;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanReceiveFile;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICCameraDeviceCanAcceptPTPCommands;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICDownloadsDirectoryURL;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICSaveAsFilename;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICSavedFilename;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICSavedAncillaryFiles;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICOverwrite;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICDeleteAfterSuccessfulDownload;
...
*/
IMAGECAPTURE_EXTERN NSString* const ICDownloadSidecarFiles;
...
/*!
 ...
 receiving one message per object, an NSArray of objects is sent.
 @discussion The objects may be instances of ICCameraFolder or ICCameraFile class.
 */
