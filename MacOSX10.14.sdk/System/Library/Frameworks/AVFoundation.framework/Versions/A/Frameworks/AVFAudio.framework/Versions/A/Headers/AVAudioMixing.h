...
*/
@property (nonatomic) AVAudio3DMixingRenderingAlgorithm renderingAlgorithm API_PROHIBITED(watchos);
...
/*! @property rate
    ...
    @discussion
        ...
        Mixer:      AVAudioEnvironmentNode
*/
@property (nonatomic) float rate API_PROHIBITED(watchos);
...
/*! @property reverbBlend
    ...
    @discussion
        ...
        Mixer:      AVAudioEnvironmentNode
*/
@property (nonatomic) float reverbBlend API_PROHIBITED(watchos);
...
/*! @property obstruction
    ...
    @discussion
        ...
        Mixer:      AVAudioEnvironmentNode
*/
@property (nonatomic) float obstruction API_PROHIBITED(watchos);
...
/*! @property occlusion
    ...
    @discussion
        ...
        Mixer:      AVAudioEnvironmentNode
*/
@property (nonatomic) float occlusion API_PROHIBITED(watchos);
...
/*! @property position
    ...
    @discussion
        ...
        Mixer:      AVAudioEnvironmentNode
*/
@property (nonatomic) AVAudio3DPoint position API_PROHIBITED(watchos);
