...
+ (instancetype)controllerWithAnimation:(CAAnimation *)animation API_PROHIBITED(watchos);
...
@property(nonatomic, retain) CAAnimation *animation API_PROHIBITED(watchos);
