 ...
 */
@property(nonatomic, retain, nullable) SCNProgram *program API_PROHIBITED(watchos);
 ...
 */
- (void)handleBindingOfSymbol:(NSString *)symbol usingBlock:(nullable SCNBindingBlock)block API_AVAILABLE(macos(10.9)) API_PROHIBITED(watchos);
...
/*!
 ...
 @discussion This method can only be used with OpenGL and OpenGLES based programs.
 */
- (void)handleUnbindingOfSymbol:(NSString *)symbol usingBlock:(nullable SCNBindingBlock)block API_AVAILABLE(macos(10.9)) API_PROHIBITED(watchos);
