...
#include <Availability.h> // Must include this header before attempting to check and define API_PROHIBITED

#ifndef API_PROHIBITED
#define API_PROHIBITED(x) API_AVAILABLE(x(10.13))
#endif
