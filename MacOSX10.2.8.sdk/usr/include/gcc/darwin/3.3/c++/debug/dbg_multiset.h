...
template<class _Key, class _Compare = std::less<_Key>,
  ...
  class _GLIBCXX_DEBUG_CLASS(multiset) multiset 
  : public _GLIBCXX_DEBUG_BASE(std, multiset)<_Key, _Compare, _Allocator>,
    public std::__debug::_Safe_sequence<multiset<_Key, _Compare, _Allocator> >
  {
    typedef _GLIBCXX_DEBUG_BASE(std, multiset)<_Key, _Compare, _Allocator>
      _Base;
    typedef std::__debug::_Safe_sequence<multiset> _Safe_base;
  ...
  public:
    ...
    typedef std::__debug::_Safe_iterator<typename _Base::iterator, multiset> 
                                                   iterator;
...
#endif /* _GLIBCXX_DEBUG_MULTISET_H */
