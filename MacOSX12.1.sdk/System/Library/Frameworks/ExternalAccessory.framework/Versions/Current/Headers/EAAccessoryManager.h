...
- (void)showBluetoothAccessoryPickerWithNameFilter:(nullable NSPredicate *)predicate completion:(nullable EABluetoothAccessoryPickerCompletion)completion API_AVAILABLE(ios(6), macCatalyst(14)) API_UNAVAILABLE(macos);
