...
template<typename _Key, typename _Tp, typename _Compare = std::less<_Key>,
  ...
  class _GLIBCXX_DEBUG_CLASS(multimap) multimap 
  : public _GLIBCXX_DEBUG_BASE(std, multimap)<_Key, _Tp, _Compare, _Allocator>,
    public std::__debug::_Safe_sequence<multimap<_Key,_Tp,_Compare,_Allocator> >
  {
    typedef _GLIBCXX_DEBUG_BASE(std, multimap)<_Key, _Tp, _Compare, _Allocator>
      _Base;
    typedef std::__debug::_Safe_sequence<multimap> _Safe_base;
  ...
  public:
    ...
    typedef std::__debug::_Safe_iterator<typename _Base::iterator, multimap> 
                                                   iterator;
...
#endif /* _GLIBCXX_DEBUG_MULTIMAP_H */
