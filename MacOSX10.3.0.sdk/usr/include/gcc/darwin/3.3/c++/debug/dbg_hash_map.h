...
template<class _Value, class _Tp,
  ...
  class _GLIBCXX_DEBUG_CLASS(hash_map) hash_map 
  : public _GLIBCXX_DEBUG_BASE(__gnu_cxx, hash_map)<_Value, _Tp, _HashFcn,
						    _EqualKey, _Alloc>,
    public std::__debug::_Safe_sequence<hash_map<_Value, _Tp, _HashFcn,
						 _EqualKey, _Alloc> >
  {
    typedef _GLIBCXX_DEBUG_BASE(__gnu_cxx, hash_map)<_Value, _Tp, _HashFcn,
                                                     _EqualKey, _Alloc> _Base;
    typedef std::__debug::_Safe_sequence<hash_map> _Safe_base;
  ...
  public:
    ...
    typedef std::__debug::_Safe_iterator<typename _Base::iterator, hash_map>
                                            iterator;
    ...
    explicit
    hash_map(size_type __n, const hasher& __hf = hasher(),
...
#endif /* _GLIBCXX_DEBUG_HASH_MAP_H */
