...
#ifndef CHUD_KEXT
int 	chudReadSPR( chud_device_t dev, chudSPR spr, uint32_t *val_p );
int	chudWriteSPR( chud_device_t dev, chudSPR spr, uint32_t *val_p );
int 	chudReadSPR64( chud_device_t dev, chudSPR spr, uint64_t *val_p );
int 	chudWriteSPR64( chud_device_t dev, chudSPR spr, uint64_t *val_p );
#endif /* !CHUD_KEXT */
#endif /* !ASSEMBLER */
