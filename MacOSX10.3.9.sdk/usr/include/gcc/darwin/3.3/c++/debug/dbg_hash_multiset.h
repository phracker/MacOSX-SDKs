...
template<class _Value,
  ...
  class _GLIBCXX_DEBUG_CLASS(hash_multiset) hash_multiset 
  : public _GLIBCXX_DEBUG_BASE(__gnu_cxx, hash_multiset)<_Value, _HashFcn,
							 _EqualKey, _Alloc>,
    public std::__debug::_Safe_sequence<hash_multiset<_Value, _HashFcn,
						      _EqualKey, _Alloc> >
  {
    typedef _GLIBCXX_DEBUG_BASE(__gnu_cxx, hash_multiset)<_Value,_HashFcn,
                                                          _EqualKey,_Alloc>
      _Base;
    typedef std::__debug::_Safe_sequence<hash_multiset> _Safe_base;
  ...
  public:
    ...
    explicit
    hash_multiset(size_type __n, const hasher& __hf = hasher(),
...
#endif /* _GLIBCXX_DEBUG_HASH_MULTISET_H */
