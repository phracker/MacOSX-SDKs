...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix=/usr' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--disable-dependency-tracking' '--prefix=/System/Library/Frameworks/Ruby.framework/Versions/2.6/usr' '--sysconfdir=/Library/Ruby/Site' '--with-sitedir=/Library/Ruby/Site' '--enable-shared' '--with-arch=x86_64,arm64e' '--with-openssl-dir=/System/Volumes/Data/SWE/macOS/BuildRoots/6b362bc7f6/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.0.Internal.sdk/usr/local/libressl' '--without-ext=tk' '--disable-silent-rules' 'ac_cv_func_getcontext=no' 'ac_cv_func_setcontext=no' 'ac_cv_func_utimensat=no' 'ac_cv_c_compiler_gnu=no' 'ac_cv_header_net_if_h=yes' 'av_cv_header_ifaddrs_h=yes' 'rb_cv_pri_prefix_long_long=ll' 'rb_cv_stack_grow_dir_arm64e=-1' 'ac_cv_sizeof_struct_stat_st_size=SIZEOF_OFF_T' 'ac_cv_sizeof_struct_stat_st_blocks=SIZEOF_INT64_T' 'ac_cv_sizeof_struct_stat_st_ino=SIZEOF_UINT64_T' 'CC=/System/Volumes/Data/SWE/macOS/BuildRoots/6b362bc7f6/Applications/Xcode.app/Contents/Developer/Toolchains/OSX12.0.xctoolchain/usr/bin/cc' 'CFLAGS=-arch x86_64 -arch arm64e -g -Os -pipe -DHAVE_GCC_ATOMIC_BUILTINS -DUSE_FFI_CLOSURE_ALLOC' 'LDFLAGS=-arch x86_64 -arch arm64e            ' 'CXX=/System/Volumes/Data/SWE/macOS/BuildRoots/6b362bc7f6/Applications/Xcode.app/Contents/Developer/Toolchains/OSX12.0.xctoolchain/usr/bin/c++' 'CXXFLAGS=-arch x86_64 -arch arm64e -g -Os -pipe '"
  ...
  CONFIG["CC_VERSION_MESSAGE"] = "Apple clang version 13.0.0 (clang-1300.0.29.1) [+internal-os, ptrauth-isa=deployment-target-based]\nTarget: x86_64-apple-darwin20.1.0\nThread model: posix\nInstalledDir: /System/Volumes/Data/SWE/macOS/BuildRoots/6b362bc7f6/Applications/Xcode.app/Contents/Developer/Toolchains/OSX12.0.xctoolchain/usr/bin"
  ...
  CONFIG["LDFLAGS"] = "-L. -L/System/Volumes/Data/SWE/macOS/BuildRoots/6b362bc7f6/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX12.0.Internal.sdk/usr/local/lib"
