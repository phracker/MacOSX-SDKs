...
*/
CF_EXPORT CFTypeID CFAttributedStringGetTypeID(void) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreate(CFAllocatorRef alloc, CFStringRef str, CFDictionaryRef attributes) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreateWithSubstring(CFAllocatorRef alloc, CFAttributedStringRef aStr, CFRange range) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/*! @function CFAttributedStringCreateCopy
Creates an immutable attributed string copy.
*/
CF_EXPORT CFAttributedStringRef CFAttributedStringCreateCopy(CFAllocatorRef alloc, CFAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFStringRef CFAttributedStringGetString(CFAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFIndex CFAttributedStringGetLength(CFAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFTypeRef CFAttributedStringGetAttribute(CFAttributedStringRef aStr, CFIndex loc, CFStringRef attrName, CFRange *effectiveRange) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFDictionaryRef CFAttributedStringGetAttributesAndLongestEffectiveRange(CFAttributedStringRef aStr, CFIndex loc, CFRange inRange, CFRange *longestEffectiveRange) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFTypeRef CFAttributedStringGetAttributeAndLongestEffectiveRange(CFAttributedStringRef aStr, CFIndex loc, CFStringRef attrName, CFRange inRange, CFRange *longestEffectiveRange) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFMutableAttributedStringRef CFAttributedStringCreateMutableCopy(CFAllocatorRef alloc, CFIndex maxLength, CFAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFMutableAttributedStringRef CFAttributedStringCreateMutable(CFAllocatorRef alloc, CFIndex maxLength) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringReplaceString(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef replacement) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT CFMutableStringRef CFAttributedStringGetMutableString(CFMutableAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringSetAttributes(CFMutableAttributedStringRef aStr, CFRange range, CFDictionaryRef replacement, Boolean clearOtherAttributes) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringSetAttribute(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef attrName, CFTypeRef value) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringRemoveAttribute(CFMutableAttributedStringRef aStr, CFRange range, CFStringRef attrName) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringReplaceAttributedString(CFMutableAttributedStringRef aStr, CFRange range, CFAttributedStringRef replacement) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
CF_EXPORT void CFAttributedStringBeginEditing(CFMutableAttributedStringRef aStr) AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
