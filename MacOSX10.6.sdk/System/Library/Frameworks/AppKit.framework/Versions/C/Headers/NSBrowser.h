 ...
 */
- (id)itemAtRow:(NSInteger)row inColumn:(NSInteger)column AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
*/
- (void)reloadDataForRowIndexes:(NSIndexSet *)rowIndexes inColumn:(NSInteger)column AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
*/
- (NSRect)frameOfRow:(NSInteger)row inColumn:(NSInteger)column AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
*/
- (BOOL)getRow:(NSInteger *)row column:(NSInteger *)column forPoint:(NSPoint)point AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
