/*
 ...
 the web starting from the LAPACK FAQ page at this URL (verified live as of August 2008):
...
/* CLAPACK Version Specific Declarations
 *
 ...
 * zlar1v, zlarrv
 *
 * Use a different API in CLAPACK 3.1.1 than was used previously.  In order to maintain backward
 * compatability for apps targeting previous OS X releases, we provide both versions of these routines.
 *
 * It is unlikely that users will wish to call these auxiliary routines directly; in the event that
 * you wish to call the CLAPACK 3.0.0 versions of these routines, you must set the MAC OS X deployment
 * target to 10.5 or earlier in XCode, or by using
 *
 *		-DMAC_OS_X_VERSION_MIN_REQUIRED=1050
 *
 * when compiling files containing calls to these routines
 *
 * The declarations below are conditioned on this choice.
 */
...
#define	clar1v_	clar1v_311_
#define	clarrv_	clarrv_311_
#define	dlar1v_	dlar1v_311_
#define	dlarrb_	dlarrb_311_
#define	dlarre_	dlarre_311_
#define	dlarrf_	dlarrf_311_
#define	dlarrv_	dlarrv_311_
#define	slar1v_	slar1v_311_
#define	slarrb_	slarrb_311_
#define	slarre_	slarre_311_
#define	slarrf_	slarrf_311_
#define	slarrv_	slarrv_311_
#define	zlar1v_	zlar1v_311_
#define	zlarrv_	zlarrv_311_
...
#endif // CLAPACK version specific declarations


/* 
 * Declarations for normal CLAPACK 3.1.1 functions and subroutines.
 */
...
/* Subroutine */ int cgelsd_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_integer *nrhs, __CLPK_complex *
	...
	iwork, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int cgelss_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_integer *nrhs, __CLPK_complex *
	a, __CLPK_integer *lda, __CLPK_complex *b, __CLPK_integer *ldb, __CLPK_real *s, __CLPK_real *rcond, 
	__CLPK_integer *rank, __CLPK_complex *work, __CLPK_integer *lwork, __CLPK_real *rwork, __CLPK_integer *
	info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int clacn2_(__CLPK_integer *n, __CLPK_complex *v, __CLPK_complex *x, __CLPK_real *est, 
	__CLPK_integer *kase, __CLPK_integer *isave) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int clag2z_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_complex *sa, __CLPK_integer *
	ldsa, __CLPK_doublecomplex *a, __CLPK_integer *lda, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int clahr2_(__CLPK_integer *n, __CLPK_integer *k, __CLPK_integer *nb, __CLPK_complex *a, 
	...
	__CLPK_integer *ldy) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int claqr0_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	work, __CLPK_integer *lwork, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int claqr1_(__CLPK_integer *n, __CLPK_complex *h__, __CLPK_integer *ldh, __CLPK_complex *
	s1, __CLPK_complex *s2, __CLPK_complex *v) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int claqr2_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	__CLPK_complex *work, __CLPK_integer *lwork) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int claqr5_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *kacc22, 
	...
	__CLPK_integer *ldwh) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int cstemr_(char *jobz, char *range, __CLPK_integer *n, __CLPK_real *d__, 
	...
	liwork, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlacn2_(__CLPK_integer *n, __CLPK_doublereal *v, __CLPK_doublereal *x, 
	...
	__CLPK_integer *isave) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlag2s_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_doublereal *a, __CLPK_integer *
	lda, __CLPK_real *sa, __CLPK_integer *ldsa, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlahr2_(__CLPK_integer *n, __CLPK_integer *k, __CLPK_integer *nb, __CLPK_doublereal *
	...
	__CLPK_doublereal *y, __CLPK_integer *ldy) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlaqr0_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	__CLPK_integer *ilo, __CLPK_integer *ihi, __CLPK_doublereal *h__, __CLPK_integer *ldh, __CLPK_doublereal 
	*wr, __CLPK_doublereal *wi, __CLPK_integer *iloz, __CLPK_integer *ihiz, __CLPK_doublereal *z__, 
	__CLPK_integer *ldz, __CLPK_doublereal *work, __CLPK_integer *lwork,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlaqr1_(__CLPK_integer *n, __CLPK_doublereal *h__, __CLPK_integer *ldh, 
	...
	__CLPK_doublereal *v) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlaqr2_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	nv, __CLPK_doublereal *wv, __CLPK_integer *ldwv, __CLPK_doublereal *work,
	__CLPK_integer *lwork) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlaqr5_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *kacc22, 
	...
	*sr, __CLPK_doublereal *si, __CLPK_doublereal *h__, __CLPK_integer *ldh, __CLPK_integer *iloz, 
	...
	__CLPK_integer *ldwv, __CLPK_integer *nh, __CLPK_doublereal *wh,
	__CLPK_integer *ldwh) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlarra_(__CLPK_integer *n, __CLPK_doublereal *d__, __CLPK_doublereal *e, 
	__CLPK_doublereal *e2, __CLPK_doublereal *spltol, __CLPK_doublereal *tnrm, __CLPK_integer *nsplit,
	 __CLPK_integer *isplit, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlarrc_(char *jobt, __CLPK_integer *n, __CLPK_doublereal *vl, 
	...
	__CLPK_integer *eigcnt, __CLPK_integer *lcnt, __CLPK_integer *rcnt,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlarrj_(__CLPK_integer *n, __CLPK_doublereal *d__, __CLPK_doublereal *e2, 
	...
	__CLPK_doublereal *pivmin, __CLPK_doublereal *spdiam,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlarrk_(__CLPK_integer *n, __CLPK_integer *iw, __CLPK_doublereal *gl, 
	...
	__CLPK_doublereal *reltol, __CLPK_doublereal *w, __CLPK_doublereal *werr,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dlazq3_(__CLPK_integer *i0, __CLPK_integer *n0, __CLPK_doublereal *z__, 
	__CLPK_integer *pp, __CLPK_doublereal *dmin__, __CLPK_doublereal *sigma, __CLPK_doublereal *desig,
	 __CLPK_doublereal *qmax, __CLPK_integer *nfail, __CLPK_integer *iter, __CLPK_integer *ndiv, 
	__CLPK_logical *ieee, __CLPK_integer *ttype, __CLPK_doublereal *dmin1, __CLPK_doublereal *dmin2, 
	__CLPK_doublereal *dn, __CLPK_doublereal *dn1, __CLPK_doublereal *dn2,
	__CLPK_doublereal *tau) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int dlazq4_(__CLPK_integer *i0, __CLPK_integer *n0, __CLPK_doublereal *z__, 
	__CLPK_integer *pp, __CLPK_integer *n0in, __CLPK_doublereal *dmin__, __CLPK_doublereal *dmin1, 
	__CLPK_doublereal *dmin2, __CLPK_doublereal *dn, __CLPK_doublereal *dn1, __CLPK_doublereal *dn2, 
	__CLPK_doublereal *tau, __CLPK_integer *ttype,
	__CLPK_doublereal *g) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int dstemr_(char *jobz, char *range, __CLPK_integer *n, __CLPK_doublereal *
	...
	__CLPK_integer *lwork, __CLPK_integer *iwork, __CLPK_integer *liwork,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int ilaver_(__CLPK_integer *vers_major__, __CLPK_integer *vers_minor__, 
	__CLPK_integer *vers_patch__) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slacn2_(__CLPK_integer *n, __CLPK_real *v, __CLPK_real *x, __CLPK_integer *isgn, 
	__CLPK_real *est, __CLPK_integer *kase, __CLPK_integer *isave) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slag2d_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_real *sa, __CLPK_integer *ldsa, 
	__CLPK_doublereal *a, __CLPK_integer *lda, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slahr2_(__CLPK_integer *n, __CLPK_integer *k, __CLPK_integer *nb, __CLPK_real *a, 
	__CLPK_integer *lda, __CLPK_real *tau, __CLPK_real *t, __CLPK_integer *ldt, __CLPK_real *y,
	__CLPK_integer *ldy) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slaqr0_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	wi, __CLPK_integer *iloz, __CLPK_integer *ihiz, __CLPK_real *z__, __CLPK_integer *ldz, __CLPK_real *work,
	 __CLPK_integer *lwork, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int slaqr1_(__CLPK_integer *n, __CLPK_real *h__, __CLPK_integer *ldh, __CLPK_real *sr1, 
	__CLPK_real *si1, __CLPK_real *sr2, __CLPK_real *si2,
	__CLPK_real *v) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slaqr2_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	work, __CLPK_integer *lwork) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slaqr5_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *kacc22, 
	...
	*z__, __CLPK_integer *ldz, __CLPK_real *v, __CLPK_integer *ldv, __CLPK_real *u, __CLPK_integer *ldu, 
	...
	ldwh) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slarra_(__CLPK_integer *n, __CLPK_real *d__, __CLPK_real *e, __CLPK_real *e2, __CLPK_real *
	spltol, __CLPK_real *tnrm, __CLPK_integer *nsplit, __CLPK_integer *isplit,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slarrc_(char *jobt, __CLPK_integer *n, __CLPK_real *vl, __CLPK_real *vu, __CLPK_real 
	*d__, __CLPK_real *e, __CLPK_real *pivmin, __CLPK_integer *eigcnt, __CLPK_integer *lcnt, __CLPK_integer *
	rcnt, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slarrd_(char *range, char *order, __CLPK_integer *n, __CLPK_real *vl, 
	...
	iblock, __CLPK_integer *indexw, __CLPK_real *work, __CLPK_integer *iwork,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slarrj_(__CLPK_integer *n, __CLPK_real *d__, __CLPK_real *e2, __CLPK_integer *ifirst,
	...
	__CLPK_real *work, __CLPK_integer *iwork, __CLPK_real *pivmin, __CLPK_real *spdiam,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slarrr_(__CLPK_integer *n, __CLPK_real *d__, __CLPK_real *e,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int slazq3_(__CLPK_integer *i0, __CLPK_integer *n0, __CLPK_real *z__, __CLPK_integer *pp,
	 __CLPK_real *dmin__, __CLPK_real *sigma, __CLPK_real *desig, __CLPK_real *qmax, __CLPK_integer *nfail, 
	__CLPK_integer *iter, __CLPK_integer *ndiv, __CLPK_logical *ieee, __CLPK_integer *ttype, __CLPK_real *
	dmin1, __CLPK_real *dmin2, __CLPK_real *dn, __CLPK_real *dn1, __CLPK_real *dn2,
	__CLPK_real *tau) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int slazq4_(__CLPK_integer *i0, __CLPK_integer *n0, __CLPK_real *z__, __CLPK_integer *pp,
	 __CLPK_integer *n0in, __CLPK_real *dmin__, __CLPK_real *dmin1, __CLPK_real *dmin2, __CLPK_real *dn, 
	__CLPK_real *dn1, __CLPK_real *dn2, __CLPK_real *tau, __CLPK_integer *ttype,
	__CLPK_real *g) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zcgesv_(__CLPK_integer *n, __CLPK_integer *nrhs, __CLPK_doublecomplex *a, 
	...
	__CLPK_integer *iter, __CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zlacn2_(__CLPK_integer *n, __CLPK_doublecomplex *v, __CLPK_doublecomplex *x, 
	__CLPK_doublereal *est, __CLPK_integer *kase, __CLPK_integer *isave) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zlag2c_(__CLPK_integer *m, __CLPK_integer *n, __CLPK_doublecomplex *a, 
	__CLPK_integer *lda, __CLPK_complex *sa, __CLPK_integer *ldsa,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zlahr2_(__CLPK_integer *n, __CLPK_integer *k, __CLPK_integer *nb, 
	...
	__CLPK_integer *ldt, __CLPK_doublecomplex *y, __CLPK_integer *ldy) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zlaqr0_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	__CLPK_integer *ilo, __CLPK_integer *ihi, __CLPK_doublecomplex *h__, __CLPK_integer *ldh, 
	__CLPK_doublecomplex *w, __CLPK_integer *iloz, __CLPK_integer *ihiz, __CLPK_doublecomplex *z__, 
	__CLPK_integer *ldz, __CLPK_doublecomplex *work, __CLPK_integer *lwork,
	__CLPK_integer *info) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;

/* Subroutine */ int zlaqr1_(__CLPK_integer *n, __CLPK_doublecomplex *h__, __CLPK_integer *ldh, 
	__CLPK_doublecomplex *s1, __CLPK_doublecomplex *s2,
	__CLPK_doublecomplex *v) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
/* Subroutine */ int zlaqr2_(__CLPK_logical *wantt, __CLPK_logical *wantz, __CLPK_integer *n, 
	...
	__CLPK_doublecomplex *work, __CLPK_integer *lwork) AVAILABLE_MAC_OS_X_VERSION_10_6_AND_LATER;
...
int csrot_(__CLPK_integer *n, __CLPK_complex *cx, __CLPK_integer *incx, __CLPK_complex *
...
int icmax1_(__CLPK_integer *n, __CLPK_complex *cx, __CLPK_integer *incx);

int ieeeck_(__CLPK_integer *ispec, __CLPK_real *zero, __CLPK_real *one);
	
int ilaenv_(__CLPK_integer *ispec, char *name__, char *opts, __CLPK_integer *n1, 
	__CLPK_integer *n2, __CLPK_integer *n3, __CLPK_integer *n4, __CLPK_ftnlen name_len, __CLPK_ftnlen 
	opts_len);
	
int izmax1_(__CLPK_integer *n, __CLPK_doublecomplex *cx, __CLPK_integer *incx);	
...
int zdrot_(__CLPK_integer *n, __CLPK_doublecomplex *cx, __CLPK_integer *incx, 
