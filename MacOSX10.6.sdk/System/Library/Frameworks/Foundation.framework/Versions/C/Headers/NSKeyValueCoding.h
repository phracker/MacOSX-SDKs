...
*/
- (void)setValue:(id)value forKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (BOOL)validateValue:(id *)ioValue forKey:(NSString *)inKey error:(NSError **)outError AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (NSMutableArray *)mutableArrayValueForKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (NSMutableSet *)mutableSetValueForKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
- (void)setValue:(id)value forKeyPath:(NSString *)keyPath AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
- (BOOL)validateValue:(id *)ioValue forKeyPath:(NSString *)inKeyPath error:(NSError **)outError AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
- (NSMutableArray *)mutableArrayValueForKeyPath:(NSString *)keyPath AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
- (NSMutableSet *)mutableSetValueForKeyPath:(NSString *)keyPath AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
...
*/
- (id)valueForUndefinedKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (void)setValue:(id)value forUndefinedKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (void)setNilValueForKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (NSDictionary *)dictionaryWithValuesForKeys:(NSArray *)keys AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (void)setValuesForKeysWithDictionary:(NSDictionary *)keyedValues AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (id)valueForKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_3_AND_LATER;
...
*/
- (id)valueForKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;

/* Invoke -setValue:forKey: on each of the receiver's members.
*/
- (void)setValue:(id)value forKey:(NSString *)key AVAILABLE_MAC_OS_X_VERSION_10_4_AND_LATER;
